...
Route::prefix('v1')->group(function () {
    ...
    Route::patch('invoice-documents/{id}/confirm', [OcrUploadController::class, 'invoiceConfirm']);
    Route::get('invoice-documents', [OcrUploadController::class, 'invoiceIndex']);
    Route::post('invoice-documents', [OcrUploadController::class, 'invoiceStore']);
    Route::get('invoice-documents/{id}', [OcrUploadController::class, 'invoiceShow']);
    Route::match(['put', 'patch'], 'invoice-documents/{id}', [OcrUploadController::class, 'invoiceUpdate']);
    Route::delete('invoice-documents/{id}', [OcrUploadController::class, 'invoiceDestroy']);
    Route::get('invoice-summary/sites/{site_id}', [OcrUploadController::class, 'invoiceSummarySites']);
    Route::get('invoice-summary', [OcrUploadController::class, 'invoiceSummary']);
